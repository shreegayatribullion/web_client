...
// let adminUrl = "https://shreegayatri.onrender.com/";
...
function LiveRate() {
  ...
  const setMcxColor = (type, target) => {
    let classNameStyle = "";
    if (
      parseInt(mcxData.find((x) => x.symbol == type)[target]) <
      parseInt(upadtedMcxData.find((x) => x.symbol == type)[target])
    ) {
      classNameStyle = "positive";
    }
    if (
      mcxData.find((x) => x.symbol == type)[target] >
      upadtedMcxData.find((x) => x.symbol == type)[target]
    ) {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (record, data, index) => {
        return (
          <div
            className={`cs-font-22 cs-fw-800`}
            style={{
              display: "flex",
          ...
          >
            {+record +
              +(data.src == "gold" ? data.defaultgold : data.defaultsilver)}
          </div>
        );
      },
    },
    {
      title: () => {
        return <div className="cs-font-22 cs-fw-800">Sell</div>;
      },
      dataIndex: "sell",
      width: 200,
      key: "sell",
    ...
    <div className="cs-90vh cs-bm-120">
      <div className="cs-tm-70">
        ...
        <div className="cs-m-15-no-top">
          ...
          <Row style={{ marginBottom: 10 }} gutter={[4, 4]}>
            <Col lg={6} xs={8}>
              <div className="ui-card">
                ...
                <div className="clr-card" style={{ padding: 8 }}>
                  ...
                  <Row>
                    ...
                    <Col lg={24} xs={24}>
                      <div className="cs-dis-flex cs-hrz-center">
                        <span
                          className={`${
                            "cs-fw-800 cs-clr-white cs-p-5 cs-gayatri-card-price " +
                            setMcxColor("XAUUSD", "Ask")
                          }`}
                        >
                          {mcxData.find((x) => x.symbol == "XAUUSD").Ask}
                        </span>
                  ...
                  >
                    ...
                    <div
                      className="cs-dis-flex cs-hrz-center cs-prime-clr"
                  ...
                  <Row>
                    {/* <Col lg={12} xs={12}>
                      <div className="cs-dis-flex cs-hrz-center">
                        <span
                          className={`${
                            "cs-font-22 cs-fw-800 cs-clr-white cs-p-5 " +
                            setMcxColor("INRSpot", "Bid")
                          }`}
                        >
            ...
            <div>
              ...
              >
                <Row gutter={[10, 10]}>
                  ...
                  <Col lg={8} xs={7}>
                    <div className="cs-dis-flex cs-hrz-center">
                      <span className="cs-font-main-header cs-fw-800">BUY</span>
                    </div>
                  </Col>
                  ...
                  <Row>
                    <Col lg={12} xs={12}>
                      <div className="cs-dis-flex cs-hrz-center">
                        <span
                          className={`${
                            "cs-font-p-25vm cs-fw-800 cs-clr-white cs-p-5 " +
                            setMcxColor("gold", "Bid")
                          }`}
                        >
